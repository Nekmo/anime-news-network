...
PACKAGE_NAME = 'anime-news-network'
PACKAGE_DOWNLOAD_URL = 'https://github.com/Nekmo/anime-news-network/archive/master.zip'  # .tar.gz
URL = 'https://github.com/Nekmo/anime-news-network'  # Project url
STATUS_LEVEL = 1  # 1:Planning 2:Pre-Alpha 3:Alpha 4:Beta 5:Production/Stable 6:Mature 7:Inactive
KEYWORDS = ['anime', 'news', 'network', 'api', 'json', 'anime-news-network']
